...
if ! grep -q -E '^CONFIG_DDR_64MB_SIZE=y' boards/${SG_BOARD_FAMILY}/${SG_BOARD_LINK}/${SG_BOARD_LINK}_defconfig ; then
  sed -i s/'ION_SIZE = .* . SIZE_1M'/'ION_SIZE = 0 * SIZE_1M'/g boards/${SG_BOARD_FAMILY}/${SG_BOARD_LINK}/memmap.py
  sed -i s/'H26X_BITSTREAM_SIZE = .* . SIZE_1M'/'H26X_BITSTREAM_SIZE = 0 * SIZE_1M'/g boards/${SG_BOARD_FAMILY}/${SG_BOARD_LINK}/memmap.py
  sed -i s/'ISP_MEM_BASE_SIZE = .* . SIZE_1M'/'ISP_MEM_BASE_SIZE = 0 * SIZE_1M'/g boards/${SG_BOARD_FAMILY}/${SG_BOARD_LINK}/memmap.py
...
if [ $dap = y ]; then
  sed -i s/'^BR2_PACKAGE_PARTED=y'/'BR2_PACKAGE_LIBSOXR=y\nBR2_PACKAGE_PARTED=y'/g configs/${BR_DEFCONFIG}
  sed -i s/'^BR2_PACKAGE_PARTED=y'/'BR2_PACKAGE_MPD=y\nBR2_PACKAGE_PARTED=y'/g configs/${BR_DEFCONFIG}
  sed -i s/'^BR2_PACKAGE_MPD=y'/'BR2_PACKAGE_MPD=y\nBR2_PACKAGE_MPD_LIBSOXR=y'/g configs/${BR_DEFCONFIG}
  sed -i s/'^BR2_PACKAGE_MPD=y'/'BR2_PACKAGE_MPD=y\nBR2_PACKAGE_MPD_OPUS=y'/g configs/${BR_DEFCONFIG}
  sed -i s/'^BR2_PACKAGE_MPD=y'/'BR2_PACKAGE_MPD=y\nBR2_PACKAGE_MPD_MPG123=y'/g configs/${BR_DEFCONFIG}
  sed -i s/'^BR2_PACKAGE_MPD=y'/'BR2_PACKAGE_MPD=y\nBR2_PACKAGE_MPD_FLAC=y'/g configs/${BR_DEFCONFIG}
  sed -i s/'^BR2_PACKAGE_MPD=y'/'BR2_PACKAGE_MPD=y\nBR2_PACKAGE_MPD_FFMPEG=y'/g configs/${BR_DEFCONFIG}
  sed -i s/'^BR2_PACKAGE_MPD=y'/'BR2_PACKAGE_MPD=y\nBR2_PACKAGE_MPD_FAAD2=y'/g configs/${BR_DEFCONFIG}
  sed -i s/'^BR2_PACKAGE_MPD=y'/'BR2_PACKAGE_MPD=y\nBR2_PACKAGE_MPD_DSD=y'/g configs/${BR_DEFCONFIG}
  sed -i s/'^BR2_PACKAGE_MPD=y'/'BR2_PACKAGE_MPD=y\nBR2_PACKAGE_MPD_AVAHI_SUPPORT=y'/g configs/${BR_DEFCONFIG}
  sed -i s/'^BR2_PACKAGE_PARTED=y'/'BR2_PACKAGE_SHAIRPORT_SYNC=y\nBR2_PACKAGE_PARTED=y'/g configs/${BR_DEFCONFIG}
  sed -i s/'^BR2_PACKAGE_SHAIRPORT_SYNC=y'/'BR2_PACKAGE_SHAIRPORT_SYNC=y\nBR2_PACKAGE_SHAIRPORT_SYNC_LIBSOXR=y'/g configs/${BR_DEFCONFIG}
fi
if [ $tailscale = y ]; then
